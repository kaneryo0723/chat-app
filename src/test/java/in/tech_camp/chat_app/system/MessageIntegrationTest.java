...
public class MessageIntegrationTest {
  ...
  public void 画像の投稿に成功する() throws Exception {
    ...
    // multipart:通常のフォームデータと一緒にファイルをアップロードする際に使われる
    mockMvc.perform(multipart("/rooms/{roomId}/messages", roomEntity.getId())
        .file((MockMultipartFile) messageForm.getImage())// MockMultiFileと宣言しないといけない。
